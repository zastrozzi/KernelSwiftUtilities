...
private struct XMLFooContent: Codable {
...
@Suite
struct XMLDecodingContainerTests {
    @Test
    func testSimpleFooContent() throws {
        let foo = XMLFooContent(
            foo: [
                "bar": "BAR",
                "baz": "BAZ",
            ],
        ...
        _ = try decoder.decode(XMLFooContent.self, from: encoded)
    }
}
