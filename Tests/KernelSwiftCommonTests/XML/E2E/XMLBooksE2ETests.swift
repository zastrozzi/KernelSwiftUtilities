...
private struct Book: Codable, Equatable, KernelXML.DynamicNodeEncoding {
    var id: String
    var author: String
    var title: String
    var genre: Genre
...
struct XMLBooksE2ETest {
    ...
    func testBookXML() throws {
        ...
        let encoder = KernelXML.XMLEncoder()
        ...
        #expect(book1.publishDate == Date(timeIntervalSince1970: 970_358_400))
        
        #expect(book1.title == "XML Developer's Guide")
        
        let data = try encoder.encode(
            book1,
            withRootKey: "book",
            header: KernelXML.Header(version: 1.0, encoding: "UTF-8")
        )
    ...
    func testCatalogXML() throws {
        ...
        #expect(catalog1.books.count == 12)
        #expect(catalog1.books[0].publishDate == Date(timeIntervalSince1970: 970_358_400))
