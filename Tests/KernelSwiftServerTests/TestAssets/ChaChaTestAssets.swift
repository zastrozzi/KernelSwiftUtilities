...
public enum ChaChaTestAssets {}

extension ChaChaTestAssets {
    public struct TestSet: Sendable {
    ...
    public static let rfc8439_1: TestSet = .init(
        key: [
    ...
    public static let rfc8439_2: TestSet = .init(
        key: [
    ...
    public static let cryptoSwift1: TestSet = .init(
        key: [
        ...
        input: [0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65],
        cipher: [0x5d, 0x9c, 0x0a, 0x9f, 0xe7, 0xd5, 0xe5]
    )
    
    public static let cryptoSwift2: TestSet = .init(
        key: [
