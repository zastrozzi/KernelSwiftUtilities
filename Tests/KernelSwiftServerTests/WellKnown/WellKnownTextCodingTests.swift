...
@Suite
struct WellKnownTextCodingTests {

    var encoder: KernelWellKnown.TextEncoder = .init()
    var decoder: KernelWellKnown.TextDecoder = .init()
    ...
    func testPoint2D() throws {
        for _ in 0..<100000 {
            ...
            let value2: KernelWellKnown.Point = try decoder.decode(from: data)
            #expect(value == value2)
        }
    }
    ...
    func testLineStringEmpty() throws {
        ...
        let data = encoder.encode(value)
        let value2: KernelWellKnown.LineString = try decoder.decode(from: data)
        #expect(value == value2)
    }
    ...
    func testPolygonEmpty() throws {
        ...
        let data = encoder.encode(value)
        let value2: KernelWellKnown.Polygon = try decoder.decode(from: data)
        #expect(value == value2)
    }
    ...
    func testMultiPointEmpty() throws {
        ...
        let data = encoder.encode(value)
        let value2: KernelWellKnown.MultiPoint = try decoder.decode(from: data)
        #expect(value == value2)
    }
