...
public enum ChartCategory: String, CaseIterable, Hashable, Identifiable {
    case all
    case apple
    case line
    case bar
...
public enum ChartType: String, Identifiable, CaseIterable {
    // Apple
    case heartBeat
...
//    }
//    
//    public var chartDescriptor: AXChartDescriptor? {
