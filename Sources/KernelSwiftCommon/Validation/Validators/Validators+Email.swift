...
extension KernelValidation.Validator where T == String {
    public static var email: KernelValidation.Validator<T> {
        .init {
            guard
                ...
                return KernelValidation.ValidatorResults.Email(isValidEmail: false)
            }
            return KernelValidation.ValidatorResults.Email(isValidEmail: true)
        }
    }
    
    public static var internationalEmail: KernelValidation.Validator<T> {
        .init {
            guard
...
extension KernelValidation.ValidatorResults.Email: KernelValidation.ValidatorResult {
