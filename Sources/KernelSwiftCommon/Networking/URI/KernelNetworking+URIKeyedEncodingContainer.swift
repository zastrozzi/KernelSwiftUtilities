...
extension KernelNetworking.URIKeyedEncodingContainer {
    
    private func _insertValue(_ node: KernelNetworking.URIEncodedNode, atKey key: Key) throws {
        try encoder.currentStackEntry.storage.insert(node, atKey: key)
    }
    
    private func _insertValue(_ node: KernelNetworking.URIEncodedNode.Primitive, atKey key: Key) throws {
...
extension KernelNetworking.URIKeyedEncodingContainer: KeyedEncodingContainerProtocol {
