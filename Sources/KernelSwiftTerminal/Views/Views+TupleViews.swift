...
extension KernelSwiftTerminal.Views {
    public struct TupleView2<
        C0: ViewGraph.View,
        C1: ViewGraph.View
    >: ViewGraph.View, ViewGraph.PrimitiveView {
        ...
        func buildNode(_ node: ViewGraph.Node) {
            node.addNode(at: 0, .init(view: content.0.view))
            node.addNode(at: 1, .init(view: content.1.view))
        }
    ...
    >: ViewGraph.View, ViewGraph.PrimitiveView {
        ...
        func buildNode(_ node: ViewGraph.Node) {
            node.addNode(at: 0, .init(view: content.0.view))
            node.addNode(at: 1, .init(view: content.1.view))
            node.addNode(at: 2, .init(view: content.2.view))
        }
    ...
    >: ViewGraph.View, ViewGraph.PrimitiveView {
        ...
        func buildNode(_ node: ViewGraph.Node) {
            ...
            node.addNode(at: 1, .init(view: content.1.view))
            node.addNode(at: 2, .init(view: content.2.view))
            node.addNode(at: 3, .init(view: content.3.view))
        }
    ...
    >: ViewGraph.View, ViewGraph.PrimitiveView {
        ...
        func buildNode(_ node: ViewGraph.Node) {
            ...
            node.addNode(at: 2, .init(view: content.2.view))
            node.addNode(at: 3, .init(view: content.3.view))
            node.addNode(at: 4, .init(view: content.4.view))
        }
    ...
    >: ViewGraph.View, ViewGraph.PrimitiveView {
        ...
        func buildNode(_ node: ViewGraph.Node) {
            ...
            node.addNode(at: 3, .init(view: content.3.view))
            node.addNode(at: 4, .init(view: content.4.view))
            node.addNode(at: 5, .init(view: content.5.view))
        }
    ...
    >: ViewGraph.View, ViewGraph.PrimitiveView {
        ...
        func buildNode(_ node: ViewGraph.Node) {
            ...
            node.addNode(at: 4, .init(view: content.4.view))
            node.addNode(at: 5, .init(view: content.5.view))
            node.addNode(at: 6, .init(view: content.6.view))
        }
    ...
    >: ViewGraph.View, ViewGraph.PrimitiveView {
        ...
        func buildNode(_ node: ViewGraph.Node) {
            ...
            node.addNode(at: 5, .init(view: content.5.view))
            node.addNode(at: 6, .init(view: content.6.view))
            node.addNode(at: 7, .init(view: content.7.view))
        }
    ...
    >: ViewGraph.View, ViewGraph.PrimitiveView {
        ...
        func buildNode(_ node: ViewGraph.Node) {
            ...
            node.addNode(at: 6, .init(view: content.6.view))
            node.addNode(at: 7, .init(view: content.7.view))
            node.addNode(at: 8, .init(view: content.8.view))
        }
    ...
    >: ViewGraph.View, ViewGraph.PrimitiveView {
        ...
        func buildNode(_ node: ViewGraph.Node) {
            ...
            node.addNode(at: 7, .init(view: content.7.view))
            node.addNode(at: 8, .init(view: content.8.view))
            node.addNode(at: 9, .init(view: content.9.view))
        }
