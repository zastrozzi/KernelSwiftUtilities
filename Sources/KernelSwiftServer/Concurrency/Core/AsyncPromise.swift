...
public final class AsyncPromise<Success: Sendable>: Sendable {
...
//    @discardableResult
    ...
    @inlinable
    public func voidFuture(for eventLoop: EventLoop) -> EventLoopFuture<Void> {
        let eventLoopPromise = eventLoop.makePromise(of: Void.self)
        eventLoopPromise.completeWithTask {
            let _ = try await self.awaitValue
        }
...
//        return future
    ...
    @inlinable
    public func future(for eventLoop: EventLoop) -> EventLoopFuture<Success> {
        let eventLoopPromise = eventLoop.makePromise(of: Success.self)
        eventLoopPromise.completeWithTask {
            return try await self.awaitValue
        }
        return eventLoopPromise.futureResult
//        return future
    }
...
extension AsyncPromise where Success == Void {
    @inlinable
