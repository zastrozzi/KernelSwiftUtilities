...
extension KernelFluentPostGIS.Geometric {
    public struct LineString2D: PostGISCodable, PostGISCollectable, OpenAPIContent {
...
//            print("LINE STRING \(coordinateSystem)")
        }
        ...
        public static func == (
            lhs: KernelFluentPostGIS.Geometric.LineString2D,
            rhs: KernelFluentPostGIS.Geometric.LineString2D
        ) -> Bool {
