...
extension KernelDynamicQuery.Fluent.Model {
    public final class DateFilter: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.dateFilter
        ...
        @OptionalField(key: "value") public var filterValue: Date?
        @OptionalField(key: "array_value") public var filterArrayValue: [Date]?
...
extension KernelDynamicQuery.Fluent.Model.DateFilter: DynamicQueryFilterModel {
...
extension KernelDynamicQuery.Fluent.Model.DateFilter: CRUDModel {
    public typealias CreateDTO = KernelDynamicQuery.Core.APIModel.DateFilter.CreateDateFilterRequest
    public typealias UpdateDTO = KernelDynamicQuery.Core.APIModel.DateFilter.UpdateDateFilterRequest
    public typealias ResponseDTO = KernelDynamicQuery.Core.APIModel.DateFilter.DateFilterResponse
