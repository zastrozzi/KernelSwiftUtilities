...
extension KernelDynamicQuery.Fluent.Model {
    public final class EnumFilter: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.enumFilter
        ...
        @Field(key: "enum_name") public var enumName: String
...
extension KernelDynamicQuery.Fluent.Model.EnumFilter: DynamicQueryFilterModel {
...
extension KernelDynamicQuery.Fluent.Model.EnumFilter: CRUDModel {
    public typealias CreateDTO = KernelDynamicQuery.Core.APIModel.EnumFilter.CreateEnumFilterRequest
    public typealias UpdateDTO = KernelDynamicQuery.Core.APIModel.EnumFilter.UpdateEnumFilterRequest
    public typealias ResponseDTO = KernelDynamicQuery.Core.APIModel.EnumFilter.EnumFilterResponse
    ...
    public static func updateFields(
        ...
        try model.updateIfChanged(\.enumName, from: dto.enumName)
