...
extension KernelDynamicQuery.Fluent.Model {
    public final class UUIDFilter: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.uuidFilter
        ...
        @OptionalField(key: "value") public var filterValue: UUID?
        @OptionalField(key: "array_value") public var filterArrayValue: [UUID]?
...
extension KernelDynamicQuery.Fluent.Model.UUIDFilter: DynamicQueryFilterModel {
...
extension KernelDynamicQuery.Fluent.Model.UUIDFilter: CRUDModel {
    public typealias CreateDTO = KernelDynamicQuery.Core.APIModel.UUIDFilter.CreateUUIDFilterRequest
    public typealias UpdateDTO = KernelDynamicQuery.Core.APIModel.UUIDFilter.UpdateUUIDFilterRequest
    public typealias ResponseDTO = KernelDynamicQuery.Core.APIModel.UUIDFilter.UUIDFilterResponse
