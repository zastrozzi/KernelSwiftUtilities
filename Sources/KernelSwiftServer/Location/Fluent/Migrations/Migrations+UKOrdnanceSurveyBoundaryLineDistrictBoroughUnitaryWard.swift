...
extension KernelLocation.Fluent.Migrations {
    public struct UKOrdnanceSurveyBoundaryLineDistrictBoroughUnitaryWard_Create_v1_0: AsyncMigration {
        public func prepare(on database: any Database) async throws {
            try await database.schema(SchemaName.ukOrdnanceSurveyBoundaryLineDistrictBoroughUnitaryWard)
        ...
        public func revert(on database: any Database) async throws {
            try await database.schema(SchemaName.ukOrdnanceSurveyBoundaryLineDistrictBoroughUnitaryWard).delete()
        }
    }
    
    public struct UKOrdnanceSurveyBoundaryLineDistrictBoroughUnitaryWard_AddGeometryConversionTrigger: AsyncMigration {
        let tableName: String = SchemaName.ukOrdnanceSurveyBoundaryLineDistrictBoroughUnitaryWard.namespaceResolvedTable
        let functionName: String = SchemaName.ukOrdnanceSurveyBoundaryLineDistrictBoroughUnitaryWard.namespaceResolvedTable + "_gc()"
        let triggerName: String = SchemaName.ukOrdnanceSurveyBoundaryLineDistrictBoroughUnitaryWard.table + "_gc"
