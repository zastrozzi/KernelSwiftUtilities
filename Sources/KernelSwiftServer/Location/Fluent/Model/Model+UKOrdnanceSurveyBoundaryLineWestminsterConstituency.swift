...
extension KernelLocation.Fluent.Model {
    public final class UKOrdnanceSurveyBoundaryLineWestminsterConstituency: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.ukOrdnanceSurveyBoundaryLineWestminsterConstituency
...
extension KernelLocation.Fluent.Model.UKOrdnanceSurveyBoundaryLineWestminsterConstituency: CRUDModel {
    public typealias ResponseDTO = KernelLocation.Core.UKOrdnanceSurvey.BoundaryLine.WestminsterConstituencyResponse
