...
extension KernelLocation.Fluent.Model {
    public final class UKOrdnanceSurveyBoundaryLineHistoricCounty: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.ukOrdnanceSurveyBoundaryLineHistoricCounty
...
extension KernelLocation.Fluent.Model.UKOrdnanceSurveyBoundaryLineHistoricCounty: CRUDModel {
    public typealias ResponseDTO = KernelLocation.Core.UKOrdnanceSurvey.BoundaryLine.HistoricCountyResponse
