...
extension KernelLocation.Fluent.Model {
    public final class UKOrdnanceSurveyBoundaryLineGreaterLondonConstituency: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.ukOrdnanceSurveyBoundaryLineGreaterLondonConstituency
...
extension KernelLocation.Fluent.Model.UKOrdnanceSurveyBoundaryLineGreaterLondonConstituency: CRUDModel {
    public typealias ResponseDTO = KernelLocation.Core.UKOrdnanceSurvey.BoundaryLine.GreaterLondonConstituencyResponse
