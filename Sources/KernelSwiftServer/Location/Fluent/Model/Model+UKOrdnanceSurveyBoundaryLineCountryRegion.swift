...
extension KernelLocation.Fluent.Model {
    public final class UKOrdnanceSurveyBoundaryLineCountryRegion: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.ukOrdnanceSurveyBoundaryLineCountryRegion
...
extension KernelLocation.Fluent.Model.UKOrdnanceSurveyBoundaryLineCountryRegion: CRUDModel {
    public typealias ResponseDTO = KernelLocation.Core.UKOrdnanceSurvey.BoundaryLine.CountryRegionResponse
