...
extension KernelLocation.Fluent.Model {
    public final class UKOrdnanceSurveyBoundaryLineDistrictBoroughUnitary: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.ukOrdnanceSurveyBoundaryLineDistrictBoroughUnitary
...
extension KernelLocation.Fluent.Model.UKOrdnanceSurveyBoundaryLineDistrictBoroughUnitary: CRUDModel {
    public typealias ResponseDTO = KernelLocation.Core.UKOrdnanceSurvey.BoundaryLine.DistrictBoroughUnitaryResponse
