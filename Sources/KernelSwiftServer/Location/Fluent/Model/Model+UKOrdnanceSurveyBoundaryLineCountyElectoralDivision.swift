...
extension KernelLocation.Fluent.Model {
    public final class UKOrdnanceSurveyBoundaryLineCountyElectoralDivision: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.ukOrdnanceSurveyBoundaryLineCountyElectoralDivision
...
extension KernelLocation.Fluent.Model.UKOrdnanceSurveyBoundaryLineCountyElectoralDivision: CRUDModel {
    public typealias ResponseDTO = KernelLocation.Core.UKOrdnanceSurvey.BoundaryLine.CountyElectoralDivisionResponse
