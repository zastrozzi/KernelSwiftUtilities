...
extension KernelLocation.Fluent.Model {
    public final class UKOrdnanceSurveyBoundaryLineScotlandAndWalesConstituency: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.ukOrdnanceSurveyBoundaryLineScotlandAndWalesConstituency
...
extension KernelLocation.Fluent.Model.UKOrdnanceSurveyBoundaryLineScotlandAndWalesConstituency: CRUDModel {
    public typealias ResponseDTO = KernelLocation.Core.UKOrdnanceSurvey.BoundaryLine.ScotlandAndWalesConstituencyResponse
