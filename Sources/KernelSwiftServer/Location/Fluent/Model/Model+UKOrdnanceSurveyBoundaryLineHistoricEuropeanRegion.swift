...
extension KernelLocation.Fluent.Model {
    public final class UKOrdnanceSurveyBoundaryLineHistoricEuropeanRegion: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.ukOrdnanceSurveyBoundaryLineHistoricEuropeanRegion
...
extension KernelLocation.Fluent.Model.UKOrdnanceSurveyBoundaryLineHistoricEuropeanRegion: CRUDModel {
    public typealias ResponseDTO = KernelLocation.Core.UKOrdnanceSurvey.BoundaryLine.HistoricEuropeanRegionResponse
