...
extension KernelLocation.Fluent.Model {
    public final class UKOrdnanceSurveyBoundaryLineDistrictBoroughUnitaryWard: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.ukOrdnanceSurveyBoundaryLineDistrictBoroughUnitaryWard
...
extension KernelLocation.Fluent.Model.UKOrdnanceSurveyBoundaryLineDistrictBoroughUnitaryWard: CRUDModel {
    public typealias ResponseDTO = KernelLocation.Core.UKOrdnanceSurvey.BoundaryLine.DistrictBoroughUnitaryWardResponse
