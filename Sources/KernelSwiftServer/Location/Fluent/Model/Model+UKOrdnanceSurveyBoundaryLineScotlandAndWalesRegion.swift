...
extension KernelLocation.Fluent.Model {
    public final class UKOrdnanceSurveyBoundaryLineScotlandAndWalesRegion: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.ukOrdnanceSurveyBoundaryLineScotlandAndWalesRegion
...
extension KernelLocation.Fluent.Model.UKOrdnanceSurveyBoundaryLineScotlandAndWalesRegion: CRUDModel {
    public typealias ResponseDTO = KernelLocation.Core.UKOrdnanceSurvey.BoundaryLine.ScotlandAndWalesRegionResponse
