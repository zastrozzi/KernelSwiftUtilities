...
extension KernelLocation.Fluent.Model {
    public final class UKOrdnanceSurveyBoundaryLineUnitaryElectoralDivision: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.ukOrdnanceSurveyBoundaryLineUnitaryElectoralDivision
...
extension KernelLocation.Fluent.Model.UKOrdnanceSurveyBoundaryLineUnitaryElectoralDivision: CRUDModel {
    public typealias ResponseDTO = KernelLocation.Core.UKOrdnanceSurvey.BoundaryLine.UnitaryElectoralDivisionResponse
