...
extension KernelASN1 {
    public struct ASN1BMPString: ASN1Codable, ASN1StringRepresentable {
...
extension KernelASN1.ASN1BMPString: ASN1Decodable, ASN1Buildable {
    public init(from asn1Type: KernelASN1.ASN1Type) throws {
        ...
        guard case let .bmpString(asn1) = asn1Type else { throw Self.decodingError(.bmpString, asn1Type) }
        self = asn1
    }
    
    public func buildASN1Type() -> KernelASN1.ASN1Type { .bmpString(self) }
}
