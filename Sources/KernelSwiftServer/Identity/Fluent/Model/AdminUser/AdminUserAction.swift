...
extension KernelIdentity.Fluent.Model {
    public final class AdminUserAction: KernelFluentNamespacedModel, @unchecked Sendable {
        public static let namespacedSchema = SchemaName.adminUserAction
        ...
        @KernelEnum(key: "type") public var type: KernelIdentity.Core.Model.LoggableAdminUserActionType
        @Field(key: "props") public var props: [String: String]?
        
        @Parent(key: "session_id") public var session: AdminUserSession
